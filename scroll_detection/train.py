...
from datasets import ScrollingDataset
from models import SixLayerCNN
...
class Trainer(object):
    def __init__(self, args):
        ...
        input_transform = transforms.Compose([TwoImagesBCHW()])
        aug_dataset = ScrollingDataset(transform=input_transform)
